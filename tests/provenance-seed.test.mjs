...
test(
  'CLI emits when invoked through a symlink (Node realpaths the ESM entry, argv[1] stays the link)',
  { skip: skipOnWindows('symlinkSync: requires admin privileges on win32') },
  () => {
