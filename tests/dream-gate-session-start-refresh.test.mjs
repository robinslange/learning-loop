...
// Integration test: dream-gate.js
...
function runGate(pluginData, { home, env = {} } = {}) {
  return spawnSync(process.execPath, [DREAM_GATE], {
    encoding: 'utf8',
    timeout: 10000,
    env: {
...
test('dream-gate writes dream-gate.json marker with nudge field', { timeout: 12000 }, () => {
