...
test('renderMarkdown surfaces the control verdict', () => {
  const md = renderMarkdown({
    ...
    consolidated: {
      hit_rate: 0.7,
      mrr: 0.6,
      by_tier: { forward: { hit_rate: 0.7 }, reverse: { hit_rate: 0.6 } },
    },
    control: {
      hit_rate: 0.71,
      mrr: 0.61,
      by_tier: { forward: { hit_rate: 0.71 }, reverse: { hit_rate: 0.6 } },
    },
  });
...
test('writeReport writes both json and md at the given stamp', () => {
  ...
  const [jsonPath, mdPath] = writeReport(
    ...
    {
      mode: 'single',
      before: { hit_rate: 1, mrr: 1, by_tier: { forward: {}, reverse: {} } },
      after: { hit_rate: 1, mrr: 1, by_tier: { forward: {}, reverse: {} } },
    },
    '20260716-000000',
  );
