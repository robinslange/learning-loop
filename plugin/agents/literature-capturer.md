...
```bash
ll-run provenance-emit.js '{"agent":"literature-capturer","action":"capture","target":"NOTE_FILENAME","source_url":"URL","overlap":"novel|partial|redundant","connections":N,"counterpoints":N,"backlinks_offered":N}'
```
