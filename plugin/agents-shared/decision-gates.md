...
- **Search stopping is not a gate.** It is handled mechanically by `convergence-check.mjs`. Gates decide whether to *start* or *write*, not whether to *continue searching*.
