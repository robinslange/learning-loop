...
Agents share 18 skills in `agents/_skills/` covering promote-gate assessment, cross-validation, source verification, coverage mapping, blindspot detection, fleeting sweep, and more.
